...
<body>
    ...
    <div class="navbarContainer">
        ...
        <div class="navbarDesktop">
            <a href="#one" class="navbar_focus border_default" onclick="filterNavbar('Home')">Home</a>
            <a href="#two" class="navbar_focus" onclick="filterNavbar('Health Benefits')"> Health Benefits</a>
            <a href="#four" class="navbar_focus" onclick="filterNavbar('Testimonies')">Testimonies</a>
            <a href="#five" class="navbar_focus" onclick="filterNavbar('Contacts')">Contacts</a>
        </div>
    ...
    <div class="products_wrapper">
        <div class="products_container EyeGlasses hidden">
            ...
            <div class="price">
                <span>P3,900</span>
                <i id="get_product_name1" onclick="showImage_1()" class="fa-solid fa-cart-shopping open_abclass"></i>
            </div>
        </div>
        ...
        <div class="products_container EyeGlasses hidden">
            ...
            <div class="price">
                <span>P7,800</span>
                <i id="get_product_name2" onclick="showImage_2()" class="fa-solid fa-cart-shopping open_abclass"></i>
            </div>
        </div>
        ...
        <div class="products_container EyeGlasses hidden">
            ...
            <input readonly type="text" class="product_name" value="M100 BLACK/WHITE" name="#" id="M100 BLACK/WHITE">
            <div class="price">
                <span>P7,800</span>
                <i id="get_product_name3" onclick="showImage_3()" class="fa-solid fa-cart-shopping open_abclass"></i>
            </div>
        </div>
        ...
        <div class="products_container EyeGlasses hidden">
            ...
            <div class="price">
                <span>P3,900</span>
                <i id="get_product_name4" onclick="showImage_4()" class="fa-solid fa-cart-shopping open_abclass"></i>
            </div>
        </div>
        ...
        <div class="products_container EyeGlasses hidden">
            ...
            <div class="price">
                <span>P3,900</span>
                <i id="get_product_name5" onclick="showImage_5()" class="fa-solid fa-cart-shopping open_abclass"></i>
            </div>
        </div>
        ...
        <div class="products_container EyeGlasses hidden">
            ...
            <div class="price">
                <span>P3,900</span>
                <i id="get_product_name6" onclick="showImage_6()" class="fa-solid fa-cart-shopping open_abclass"></i>
            </div>
        </div>
        ...
        <div class="products_container EyeGlasses hidden">
            ...
            <div class="price">
                <span>P3,900</span>
                <i id="get_product_name7" onclick="showImage_7()" class="fa-solid fa-cart-shopping open_abclass"></i>
            </div>
        </div>
        <div class="products_container EyeGlasses hidden">
            ...
            <div class="price">
                <span>P7,800</span>
                <i id="get_product_name8" onclick="showImage_8()" class="fa-solid fa-cart-shopping open_abclass"></i>
            </div>
        </div>
        ...
        <div class="products_container OtherProducts hidden">
            ...
            <div class="price">
                <span>P4,875</span>
                <i onclick="showImage_9()" class="fa-solid fa-cart-shopping open_abclass" id="get_product_name9"></i>
            </div>
        </div>
        ...
        <div class="products_container OtherProducts hidden">
            ...
            <div class="price">
                <span>P1,950</span>
                <i onclick="showImage_10()" class="fa-solid fa-cart-shopping open_abclass" id="get_product_name10"></i>
            </div>
        </div>
        ...
        <div class="products_container OtherProducts hidden">
            ...
            <div class="price">
                <span>P7,800</span>
                <i onclick="showImage_B1()" class="fa-solid fa-cart-shopping open_abclass" id="get_product_nameB1"></i>
            </div>
        </div>
        ...
        <div class="products_container OtherProducts hidden">
            ...
            <div class="price">
                <span>P1,950</span>
                <i onclick="showImage_B2()" class="fa-solid fa-cart-shopping open_abclass" id="get_product_nameB2"></i>
            </div>
        </div>
    </div>
                ...
                <div class="abclass_content">
                    ...
                    <div class="price_fixed">
                        ...
                        <div class="quantity_increment">
                            <div class="col-md-4 quantity_center">
                    ...
                    <div id="submit">
                        <button type="submit" onclick="submit_alert()">Place an Order</button>
                    </div>
                </div>
            </form>
        </div>
